...
<head>
    <meta charset="utf-8">
    <title> @yield('title', env('APP_NAME', 'angel')) - 通用后台管理系统</title>
    ...
    <div class="layui-layout layui-layout-admin">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    ...
                    <li data-name="component" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd data-name="dropdown">
                                <a lay-href="component/dropdown/index.html">下拉菜单</a>
                            </dd>
                            <dd data-name="upload">
                    ...
                    <li data-name="senior" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd>
                                <a lay-href="senior/im/">WebIM UI</a>
                            </dd>
                    ...
                    <li data-name="user" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd>
                                <a lay-href=" {{ route("admin.index") }}">后台管理员</a>
                            </dd>
                            <dd>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="{{ route('admin.dashboard') }}" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
